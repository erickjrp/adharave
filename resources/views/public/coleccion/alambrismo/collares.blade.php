...
@section('content')
	...
	@include('public.coleccion.alambrismo.intro_collares')

	<?php

	$imagenes[0][0] = "collar.jpg";
	$imagenes[0][1] = "collar.jpg";
	$imagenes[1][0] = "collar.jpg";
	$imagenes[1][1] = "collar.jpg";
	$imagenes[2][0] = "collar.jpg";
	$imagenes[2][1] = "collar.jpg";
	$imagenes[3][0] = "collar.jpg";
	$imagenes[3][1] = "collar.jpg";
	$imagenes[4][0] = "collar.jpg";
	$imagenes[4][1] = "collar.jpg";
	$imagenes[5][0] = "collar.jpg";
	$imagenes[5][1] = "collar.jpg";

	$nombres[0]  = "Alambrismo Collar";
	$nombres[1]  = "Alambrismo Collar";
	$nombres[2]  = "Alambrismo Collar";
	$nombres[3]  = "Alambrismo Collar";
	$nombres[4]  = "Alambrismo Collar";
	$nombres[5]  = "Alambrismo Collar";
				...
				<div id="articulo_{!!$i!!}_carrusel" class="carousel slide" data-ride="carousel" data-interval="false">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="{{ URL::asset('images/categorias/alambrismo/collares/'.$imagenes[$i][0]) }}" alt="Anillo">
						</div>
						<div class="item">
							<img src="{{ URL::asset('images/categorias/alambrismo/collares/'.$imagenes[$i][1]) }}" alt="Anillo">
						</div>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div id="articulo_{!!$i!!}_carrusel_2" class="carousel slide" data-ride="carousel" data-interval="false">
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<img src="{{ URL::asset('images/categorias/alambrismo/collares/'.$imagenes[$i][0]) }}" alt="Anillo" class="center-block">
								</div>
								<div class="item">
									<img src="{{ URL::asset('images/categorias/alambrismo/collares/'.$imagenes[$i][1]) }}" alt="Anillo" class="center-block">
								</div>
							</div>
