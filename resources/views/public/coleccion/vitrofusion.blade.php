...
@section('content')
	...
	$imagenes[0][0] = "vitrofusion.jpg";
	$imagenes[0][1] = "vitrofusion.jpg";
				...
				<div id="articulo_{!!$i!!}_carrusel" class="carousel slide" data-ride="carousel" data-interval="false">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="{{ URL::asset('images/categorias/vitrofusion/'.$imagenes[$i][0]) }}" alt="Anillo">
						</div>
						<div class="item">
							<img src="{{ URL::asset('images/categorias/vitrofusion/'.$imagenes[$i][1]) }}" alt="Anillo">
						</div>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div id="articulo_{!!$i!!}_carrusel_2" class="carousel slide" data-ride="carousel" data-interval="false">
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<img src="{{ URL::asset('images/categorias/vitrofusion/'.$imagenes[$i][0]) }}" alt="Anillo" class="center-block">
								</div>
								<div class="item">
									<img src="{{ URL::asset('images/categorias/vitrofusion/'.$imagenes[$i][1]) }}" alt="Anillo" class="center-block">
								</div>
							</div>
