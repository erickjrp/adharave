	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title" id="gridSystemModalLabel"><i>Soutache</i></h3>
			</div>
...
<div class="modal fade modal_alambrismo" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h3 class="modal-title" id="gridSystemModalLabel"><i>Alambrismo</i></h3>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12">
